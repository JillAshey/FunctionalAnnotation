...
Acerv_annot <- read.csv("Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Acerv_annot_20211101.csv", header=T, na.strings=c("","NA", "---NA---", "no IPS match", "no GO terms", "n/a"))
...
write.csv(GO_all, "Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Acerv_GOterms_20211104.csv")
...
```{r}
# Load acerv full annot results (diamond blast, swissprot, InterProScan; B2G)
Mcav_annot <- read.csv("Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Mcav_annot_20211109.csv", header=T, na.strings=c("","NA", "---NA---", "no IPS match", "no GO terms", "n/a"))
...
GO_all <- rbind(GO_blast, GO_swiss, GO_IPS)
GO_all <- unique(GO_all)
write.csv(GO_all, "Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Mcav_GOterms_20211109.csv")
...
Ofav_annot <- read.csv("Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Ofav_annot_20211113.csv", header=T, na.strings=c("","NA", "---NA---", "no IPS match", "no GO terms", "n/a"))
...
GO_all <- rbind(GO_blast, GO_swiss, GO_IPS)
GO_all <- unique(GO_all)
write.csv(GO_all, "Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Ofav_GOterms_20211114.csv")
...
Mcap_annot <- read.csv("~/Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Mcap_annot_20220417.csv", header=T, na.strings=c("","NA", "---NA---", "no IPS match", "no GO terms", "n/a"))
...
GO_all <- rbind(GO_swiss,
                ...
                GO_IPS)
GO_all <- unique(GO_all)
write.csv(GO_all, "~/Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Mcap_GOterms_20220417.csv")
...
```{r}
# Load pacuta full annot results (diamond blast, swissprot, InterProScan; B2G)
Pacuta_annot <- read.csv("Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Pacuta_annot_20220121.csv", header=T, na.strings=c("","NA", "---NA---", "no IPS match", "no GO terms", "n/a"))
...
GO_all <- rbind(GO_blast, GO_swiss, GO_IPS)
GO_all <- unique(GO_all)
write.csv(GO_all, "Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Pacuta_GOterms_20220121.csv")
...
```{r}
# Load acerv full annot results (diamond blast, swissprot, InterProScan; B2G)
Plob_annot <- read.csv("Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Plob_annot_20211106.csv", header=T, na.strings=c("","NA", "---NA---", "no IPS match", "no GO terms", "n/a"))
...
GO_all <- rbind(GO_blast, GO_swiss, GO_IPS)
GO_all <- unique(GO_all)
write.csv(GO_all, "Desktop/PutnamLab/Repositories/FunctionalAnnotation/FunctionalAnnotation/final_Annotations/Plob_GOterms_20220121.csv")
